...
class CreateIspMinimunPermanencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('isp_minimun_permanences', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('isp_minimun_permanences');
    }
}
