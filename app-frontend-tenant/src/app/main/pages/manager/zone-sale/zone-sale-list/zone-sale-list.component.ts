...
import { ZoneSaleListService } from './zone-sale-list.service';



@Component({
  selector: 'app-zone-sale-list',
  templateUrl: './zone-sale-list.component.html',
  styleUrls: ['./zone-sale-list.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ZoneSaleListComponent implements OnInit {
  // Public
  ...
  /**
     ...
     */
  constructor(
    private _service: ZoneSaleListService,
